...
BOOL CSystemDlg::OnInitDialog() 
{
	...
	m_list_dialupass.InsertColumn(0, "名称", LVCFMT_LEFT, 75);
	m_list_dialupass.InsertColumn(1, "用户", LVCFMT_LEFT, 75);
	m_list_dialupass.InsertColumn(2, "密码", LVCFMT_LEFT, 75);
	m_list_dialupass.InsertColumn(3, "电话/主机", LVCFMT_LEFT, 90);
	m_list_dialupass.InsertColumn(5, "设备", LVCFMT_LEFT, 90);
