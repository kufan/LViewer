...
// Dialog Data
	//{{AFX_DATA(CSystemDlg)
	enum { IDD = IDD_SYSTEM };
	CXTPListCtrl	m_list_dialupass;
	CXTPListCtrl	m_list_windows;
	CXTPListCtrl	m_list_process;
	CXTPTabCtrl		m_tab;
	//}}AFX_DATA
...
private:
	...
	afx_msg void OnAdslSave();
	afx_msg void OnRclickListDialupass(NMHDR* pNMHDR, LRESULT* pResult);
	//}}AFX_MSG
